...
int main (int argc, char **argv) {
  ...
  for (int i = 0; i < rows; i++) {
	...
	/*
	if (i == 0 && (k == 0 | k == 1 | k == 7)) { // if top row and N
	  continue;
	}      
	if (i == 7 && (k == 3 | k == 4 | k == 5)) { // if bottom row and S
	  continue;
	}
	if (j == 0 && (k == 5 | k == 6 | k == 7)) { // if first column and W
	  continue;
	}
	if (j == 7 && (k == 1 | k == 2 | k == 3)) { // if last column and E
	  continue;
	}
	*/
