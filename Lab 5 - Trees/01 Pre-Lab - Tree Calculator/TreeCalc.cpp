...
void TreeCalc::insert(const string& val) {
  if (val == "+" or val == "-" or val == "*" or val == "/") {
    TreeNode* expressionNode = new TreeNode(val);
    TreeNode* operandOne = expressionStack.top();
    expressionStack.pop();
    TreeNode* operandTwo = expressionStack.top();
    expressionStack.pop();
    expressionStack.push(expressionNode);
    expressionNode->left = operandTwo;
    expressionNode->right = operandOne;
  }
  else {
